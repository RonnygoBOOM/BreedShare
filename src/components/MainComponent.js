    ...
    return (
      <div>
        ...
        <Routes>
          ...
          <Route path='/directory' element={<Directory breed={this.state.breed}/> OnClick={this.state.onBreedSelect}} />
          <Route path='/directory' element={<BreedInfo breed={this.state.breed.filter(breed => breed.id === id)[0]}
        comments={this.state.comments.filter(comment => comment.breedId === id)}/> }/>
